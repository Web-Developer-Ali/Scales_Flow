...
const navItems = [
  ...
  { label: "My Deals", href: "/manager/my-deals", icon: Users },
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80">
      <div className="mx-auto px-3 sm:px-6 flex items-center justify-between h-16 gap-2">
        ...
        {/* Desktop Navigation - only shows once there's real room (xl+) */}
        ...
        <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
          ...
          {/* Mobile Menu Button - now shows below lg, since nav collapses at lg */}
          <button
